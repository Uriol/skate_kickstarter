...
var skateboard_center_vs;
var skateboard_center_center_pivot_line_vs;
var skateboard_center_tail_pivot_line_vs;
var skateboard_center_nose_pivot_line_vs;

function drawSkateboard_center_vs(){

	skateboard_center_vs = new THREE.Object3D();
	skateboard_center_vs.name = 'skateboardObject_vs';
	// Draw the lines in the skateboard
	drawLines_center_vs();
	// Draw the parts of the skateboard with triangles
	drawVertices_center_vs();

	scene_vs.add(skateboard_center_vs);
}

function drawVertices_center_vs(){
	...
	var skateboard_center_tail_pivot_geometry_vs = new THREE.Geometry();
	skateboard_center_tail_pivot_line_vs = new THREE.Line(skateboard_center_tail_pivot_geometry_vs);
	skateboard_center_tail_pivot_line_vs.position.x = -24;
	skateboard_center_vs.add(skateboard_center_tail_pivot_line_vs);

	var skateboard_center_center_pivot_geometry_vs = new THREE.Geometry();
	skateboard_center_center_pivot_line_vs = new THREE.Line(skateboard_center_center_pivot_geometry_vs);
	skateboard_center_center_pivot_line_vs.position.x = 0;
	skateboard_center_vs.add(skateboard_center_center_pivot_line_vs);

	var skateboard_center_nose_pivot_geometry_vs = new THREE.Geometry();
	skateboard_center_nose_pivot_line_vs = new THREE.Line(skateboard_center_nose_pivot_geometry_vs);
	skateboard_center_nose_pivot_line_vs.position.x =24;
	skateboard_center_vs.add(skateboard_center_nose_pivot_line_vs);
	...
	skateboard_center_vs.add(bottom);
	...
	skateboard_center_vs.add(rightEdge);
	...
	skateboard_center_vs.add(leftEdge);
	...
	skateboard_center_vs.add(tail_right_edge_concave_mesh);
	...
	skateboard_center_vs.add(tail_left_edge_concave_mesh);
	...
	skateboard_center_vs.add(nose_right_edge_concave_mesh);
	...
	skateboard_center_vs.add(nose_left_edge_concave_mesh);
	...
	skateboard_center_vs.add(tail_top_concave_mesh);
	...
	skateboard_center_vs.add(tail_bottom_concave_mesh);
	...
	skateboard_center_vs.add(nose_top_concave_mesh);
	...
	skateboard_center_vs.add(nose_bottom_concave_mesh);
	...
	skateboard_center_vs.add(tail_top_right_edge_mesh);
	...
	skateboard_center_vs.add(tail_top_left_edge_mesh);
	...
	skateboard_center_vs.add(tail_top_mesh);
	...
	skateboard_center_vs.add(tail_bottom_mesh);
	...
	skateboard_center_vs.add(nose_right_edge_mesh);
	...
	skateboard_center_vs.add(nose_left_edge_mesh);
	...
	skateboard_center_vs.add(nose_top_mesh);
	...
	skateboard_center_vs.add(nose_bottom_mesh);
}