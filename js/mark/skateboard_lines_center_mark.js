function drawLines_center_mark(){

	

	if (onGround_bool_mark == true || reception_mark == true) {
		//grey = new THREE.Color("rgb(250, 30, 30)");
		yellowLineMaterial_mark = new THREE.LineBasicMaterial({ color: grey_mark, linewidth: 1.5 });
		blueLineMaterial_mark = new THREE.LineBasicMaterial({ color: grey_mark, linewidth: 1.5 });
	}  else {
		yellowLine_mark = new THREE.Color("rgb(184, 228, 20)");
		yellowLineMaterial_mark = new THREE.LineBasicMaterial({ color: yellowLine_mark, linewidth: 1.5 });
		blueLine_mark = new THREE.Color("rgb(0, 200, 255)");
		blueLineMaterial_mark = new THREE.LineBasicMaterial({ color: blueLine_mark, linewidth: 1.5 });
	}
	...
	center_right_top_line_Geometry.vertices.push(new THREE.Vector3(20, 0, 0));
	var center_right_top_line = new THREE.Line(center_right_top_line_Geometry, yellowLineMaterial_mark);
	center_right_top_line.position.y = 0.5;
	center_right_top_line.position.z = 10;
	skateboard_center_mark.add(center_right_top_line);
	...
	center_right_bottom_line_Geometry.vertices.push(new THREE.Vector3(20, 0, 0));
	var center_right_bottom_line = new THREE.Line(center_right_bottom_line_Geometry, yellowLineMaterial_mark);
	center_right_bottom_line.position.y = -0.2;
	center_right_bottom_line.position.z = 10;
	skateboard_center_mark.add(center_right_bottom_line);
	...
	center_left_top_line_Geometry.vertices.push(new THREE.Vector3(20, 0, 0));
	var center_left_top_line = new THREE.Line(center_left_top_line_Geometry, blueLineMaterial_mark);
	center_left_top_line.position.y = 0.5;
	center_left_top_line.position.z = -10;
	skateboard_center_mark.add(center_left_top_line);
	...
	center_left_bottom_line_Geometry.vertices.push(new THREE.Vector3(20, 0, 0));
	var center_left_bottom_line = new THREE.Line(center_left_bottom_line_Geometry, blueLineMaterial_mark);
	center_left_bottom_line.position.y = -0.2;
	center_left_bottom_line.position.z = -10;
	skateboard_center_mark.add(center_left_bottom_line);
	...
	var concave_right_top_line = new THREE.Line(concave_right_top_line_Geometry, yellowLineMaterial_mark);
	concave_right_top_line.position.z = 10;
	skateboard_center_mark.add(concave_right_top_line);
	...
	var concave_right_bottom_line = new THREE.Line(concave_right_bottom_line_Geometry, yellowLineMaterial_mark);
	concave_right_bottom_line.position.z = 10;
	skateboard_center_mark.add(concave_right_bottom_line);
	...
	var concave_nose_right_top_line = new THREE.Line(concave_nose_right_top_line_Geometry, yellowLineMaterial_mark);
	concave_nose_right_top_line.position.z = 10;
	skateboard_center_mark.add(concave_nose_right_top_line);
	...
	var concave_nose_right_bottom_line = new THREE.Line(concave_nose_right_bottom_line_Geometry, yellowLineMaterial_mark);
	concave_nose_right_bottom_line.position.z = 10;
	skateboard_center_mark.add(concave_nose_right_bottom_line);
	...
	var concave_left_top_line = new THREE.Line(concave_left_top_line_Geometry, blueLineMaterial_mark);
	concave_left_top_line.position.z = -10;
	skateboard_center_mark.add(concave_left_top_line);
	...
	var concave_left_bottom_line = new THREE.Line(concave_left_bottom_line_Geometry, blueLineMaterial_mark);
	concave_left_bottom_line.position.z = -10;
	skateboard_center_mark.add(concave_left_bottom_line);
	...
	var concave_nose_left_top_line = new THREE.Line(concave_nose_left_top_line_Geometry, blueLineMaterial_mark);
	concave_nose_left_top_line.position.z = -10;
	skateboard_center_mark.add(concave_nose_left_top_line);
	...
	var concave_nose_left_bottom_line = new THREE.Line(concave_nose_left_bottom_line_Geometry, blueLineMaterial_mark);
	concave_nose_left_bottom_line.position.z = -10;
	skateboard_center_mark.add(concave_nose_left_bottom_line);
	...
	var tail_top_right_edge_line = new THREE.Line(tail_top_right_edge_line_Geometry, yellowLineMaterial_mark);
	skateboard_center_mark.add(tail_top_right_edge_line);
	...
	var tail_bottom_right_edge_line = new THREE.Line(tail_bottom_right_edge_line_Geometry, yellowLineMaterial_mark);
	skateboard_center_mark.add(tail_bottom_right_edge_line);
	...
	var tail_top_left_edge_line = new THREE.Line(tail_top_left_edge_line_Geometry, blueLineMaterial_mark);
	skateboard_center_mark.add(tail_top_left_edge_line);
	...
	var tail_bottom_left_edge_line = new THREE.Line(tail_bottom_left_edge_line_Geometry, blueLineMaterial_mark);
	skateboard_center_mark.add(tail_bottom_left_edge_line);
	...
	var nose_top_left_edge_line = new THREE.Line(nose_top_left_edge_line_Geometry, blueLineMaterial_mark);
	skateboard_center_mark.add(nose_top_left_edge_line);
	...
	var nose_bottom_left_edge_line = new THREE.Line(nose_bottom_left_edge_line_Geometry, blueLineMaterial_mark);
	skateboard_center_mark.add(nose_bottom_left_edge_line);
	...
	var nose_top_right_edge_line = new THREE.Line(nose_top_right_edge_line_Geometry, yellowLineMaterial_mark);
	skateboard_center_mark.add(nose_top_right_edge_line);
	...
	var nose_bottom_right_edge_line = new THREE.Line(nose_bottom_right_edge_line_Geometry, yellowLineMaterial_mark);
	skateboard_center_mark.add(nose_bottom_right_edge_line);
}