...
var prev_skateboard_tail = 0, prev_skateboard_center = 0, prev_skateboard_nose = 0;
...
function drawTrick(){
	...
	for (var i = 0; i < $total_x_positions.length; i++) {
		...
		// console.log('this_z_position: ' + this_z_position);
		...
		//console.log('this: ' + this_y_position)
		increment_x_position = this_y_position - previous_x_position;
		//console.log(increment_x_position);
		final_x_position = increment_x_position + previous_x_position;

		//console.log('final:' + final_x_position);
		increment_y_position = this_z_position - previous_y_position;
		// console.log('this: ' + this_y_position);
		// console.log('increment: ' + increment_y_position);
		final_y_position = increment_y_position + previous_y_position;

		increment_z_position = this_x_position - previous_z_position;
		final_z_position = increment_z_position + previous_z_position;


		skateboard.position.x = (final_x_position);
		skateboard.position.y = final_y_position;
		skateboard.position.z = final_z_position;
		previous_x_position = this_y_position;
		previous_y_position = this_z_position;
		previous_z_position = this_x_position;
