function drawLines_center_vs(){

	

	if (onGround_bool_vs == true || reception_vs == true) {
		//grey = new THREE.Color("rgb(250, 30, 30)");
		yellowLineMaterial_vs = new THREE.LineBasicMaterial({ color: grey_vs, linewidth: 1.5 });
		blueLineMaterial_vs = new THREE.LineBasicMaterial({ color: grey_vs, linewidth: 1.5 });
	}  else {
		//yellowLine_vs = new THREE.Color("rgb(184, 228, 20)");
		yellowLineMaterial_vs = new THREE.LineBasicMaterial({ color: yellowLine_vs, linewidth: 1.5 });
		//blueLine_vs = new THREE.Color("rgb(0, 200, 255)");
		blueLineMaterial_vs = new THREE.LineBasicMaterial({ color: blueLine_vs, linewidth: 1.5 });
	}
	...
	center_right_top_line_Geometry.vertices.push(new THREE.Vector3(20, 0, 0));
	var center_right_top_line = new THREE.Line(center_right_top_line_Geometry, yellowLineMaterial_vs);
	center_right_top_line.position.y = 0.5;
	center_right_top_line.position.z = 10;
	skateboard_center_vs.add(center_right_top_line);
	...
	center_right_bottom_line_Geometry.vertices.push(new THREE.Vector3(20, 0, 0));
	var center_right_bottom_line = new THREE.Line(center_right_bottom_line_Geometry, yellowLineMaterial_vs);
	center_right_bottom_line.position.y = -0.2;
	center_right_bottom_line.position.z = 10;
	skateboard_center_vs.add(center_right_bottom_line);
	...
	center_left_top_line_Geometry.vertices.push(new THREE.Vector3(20, 0, 0));
	var center_left_top_line = new THREE.Line(center_left_top_line_Geometry, blueLineMaterial_vs);
	center_left_top_line.position.y = 0.5;
	center_left_top_line.position.z = -10;
	skateboard_center_vs.add(center_left_top_line);
	...
	center_left_bottom_line_Geometry.vertices.push(new THREE.Vector3(20, 0, 0));
	var center_left_bottom_line = new THREE.Line(center_left_bottom_line_Geometry, blueLineMaterial_vs);
	center_left_bottom_line.position.y = -0.2;
	center_left_bottom_line.position.z = -10;
	skateboard_center_vs.add(center_left_bottom_line);
	...
	var concave_right_top_line = new THREE.Line(concave_right_top_line_Geometry, yellowLineMaterial_vs);
	concave_right_top_line.position.z = 10;
	skateboard_center_vs.add(concave_right_top_line);
	...
	var concave_right_bottom_line = new THREE.Line(concave_right_bottom_line_Geometry, yellowLineMaterial_vs);
	concave_right_bottom_line.position.z = 10;
	skateboard_center_vs.add(concave_right_bottom_line);
	...
	var concave_nose_right_top_line = new THREE.Line(concave_nose_right_top_line_Geometry, yellowLineMaterial_vs);
	concave_nose_right_top_line.position.z = 10;
	skateboard_center_vs.add(concave_nose_right_top_line);
	...
	var concave_nose_right_bottom_line = new THREE.Line(concave_nose_right_bottom_line_Geometry, yellowLineMaterial_vs);
	concave_nose_right_bottom_line.position.z = 10;
	skateboard_center_vs.add(concave_nose_right_bottom_line);
	...
	var concave_left_top_line = new THREE.Line(concave_left_top_line_Geometry, blueLineMaterial_vs);
	concave_left_top_line.position.z = -10;
	skateboard_center_vs.add(concave_left_top_line);
	...
	var concave_left_bottom_line = new THREE.Line(concave_left_bottom_line_Geometry, blueLineMaterial_vs);
	concave_left_bottom_line.position.z = -10;
	skateboard_center_vs.add(concave_left_bottom_line);
	...
	var concave_nose_left_top_line = new THREE.Line(concave_nose_left_top_line_Geometry, blueLineMaterial_vs);
	concave_nose_left_top_line.position.z = -10;
	skateboard_center_vs.add(concave_nose_left_top_line);
	...
	var concave_nose_left_bottom_line = new THREE.Line(concave_nose_left_bottom_line_Geometry, blueLineMaterial_vs);
	concave_nose_left_bottom_line.position.z = -10;
	skateboard_center_vs.add(concave_nose_left_bottom_line);
	...
	var tail_top_right_edge_line = new THREE.Line(tail_top_right_edge_line_Geometry, yellowLineMaterial_vs);
	skateboard_center_vs.add(tail_top_right_edge_line);
	...
	var tail_bottom_right_edge_line = new THREE.Line(tail_bottom_right_edge_line_Geometry, yellowLineMaterial_vs);
	skateboard_center_vs.add(tail_bottom_right_edge_line);
	...
	var tail_top_left_edge_line = new THREE.Line(tail_top_left_edge_line_Geometry, blueLineMaterial_vs);
	skateboard_center_vs.add(tail_top_left_edge_line);
	...
	var tail_bottom_left_edge_line = new THREE.Line(tail_bottom_left_edge_line_Geometry, blueLineMaterial_vs);
	skateboard_center_vs.add(tail_bottom_left_edge_line);
	...
	var nose_top_left_edge_line = new THREE.Line(nose_top_left_edge_line_Geometry, blueLineMaterial_vs);
	skateboard_center_vs.add(nose_top_left_edge_line);
	...
	var nose_bottom_left_edge_line = new THREE.Line(nose_bottom_left_edge_line_Geometry, blueLineMaterial_vs);
	skateboard_center_vs.add(nose_bottom_left_edge_line);
	...
	var nose_top_right_edge_line = new THREE.Line(nose_top_right_edge_line_Geometry, yellowLineMaterial_vs);
	skateboard_center_vs.add(nose_top_right_edge_line);
	...
	var nose_bottom_right_edge_line = new THREE.Line(nose_bottom_right_edge_line_Geometry, yellowLineMaterial_vs);
	skateboard_center_vs.add(nose_bottom_right_edge_line);
